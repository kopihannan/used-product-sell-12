...
const Card = ({ product, setBooking }) => {
    const { image, title, sellername, resalePrice, orginalPrice, yearOfUse, postedAgo,isVerified } = product;
    ...
    return (
        <div className='my-20'>
            <div className='border w-96 mx-auto h-[450px] px-6 shadow rounded relative'>
                <div className='flex items-center pt-3'>
                    <h1 className='font-medium '>{sellername}</h1>
                    {
                        isVerified? <img className='w-5 h-5 ml-1' src={verified} alt=""/>: ""
                    }
                </div>
